...
void ajoutPatient::on_pushButton_clicked(){
    ...
    if(newPrenom.contains(regex)){

        QMessageBox::warning(this, tr("Prenom invalide"),
                             "Veuillez remplir un prenom sans accents ou caracteres speciaux");

        return;
    }

    if(newNomFamille.contains(regex)){

        QMessageBox::warning(this, tr("Nom invalide"),
                             "Veuillez remplir un nom sans accents ou caracteres speciaux");
